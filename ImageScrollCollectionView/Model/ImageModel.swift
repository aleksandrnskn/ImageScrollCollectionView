...
struct ImageModel {
    ...
    static func setImages() -> [ImageModel] {
        ...
        let image3 = ImageModel(imageURL: "image/cache/catalog/p/8047/9t0a4451-h_1_630x840.jp")
        ...
        let image6 = ImageModel(imageURL: "image/image/cache/catalog/p/8024/9t0a8178-h_1_630x840.jpg")
